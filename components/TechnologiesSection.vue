...
<template>
  ...
  >
    ...
    <div
      class="container mx-auto py-6 md:py-10 relative"
      ref="containerRef"
    ...
    >
      ...
      <div class="carousel-container relative w-full px-10">
        ...
        <button
          @click="prevSlide"
          class="carousel-nav-button carousel-prev flex items-center justify-center w-10 h-10 bg-[rgba(255,255,255,0.2)] text-[white] cursor-pointer transition-[background-color] duration-[0.3s] ease-[ease] rounded-[50%] border-[none] absolute left-0 top-1/2 transform -translate-y-1/2 z-10 hover:bg-[rgba(255,255,255,0.4)] dark:bg-[rgba(30,64,175,0.2)] dark:text-blue-800 dark:hover:bg-[rgba(30,64,175,0.4)]"
          aria-label="zurück"
        >
          <svg
        ...
        <!-- Контейнер с картами -->
        <!-- Определяет местоположение и видимую область -->
        <div class="carousel-track-container overflow-hidden">
          <!-- Передвижная часть карусели -->
          <div
          ...
          >
            <TechnologyCard
              ...
              :key="`tech-${index}`"
              class="carousel-slide flex-shrink-0 my-8"
        ...
        <button
          @click="nextSlide"
          class="carousel-nav-button carousel-next flex items-center justify-center w-10 h-10 bg-[rgba(255,255,255,0.2)] text-[white] cursor-pointer transition-[background-color] duration-[0.3s] ease-[ease] rounded-[50%] border-[none] absolute right-0 top-1/2 transform -translate-y-1/2 z-10 hover:bg-[rgba(255,255,255,0.4)] dark:bg-[rgba(30,64,175,0.2)] dark:text-blue-800 dark:hover:bg-[rgba(30,64,175,0.4)]"
          aria-label="vorwärts"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
